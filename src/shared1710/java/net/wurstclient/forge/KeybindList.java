...
public final class KeybindList
{
	...
	private void migrateClickGuiKeybind()
	{
		keybinds.removeIf(keybind -> "clickgui".equalsIgnoreCase(
			keybind.getCommands())
			&& ("LCONTROL".equals(keybind.getKey())
				|| "RSHIFT".equals(keybind.getKey())
				|| "RCONTROL".equals(keybind.getKey())));

		keybinds.removeIf(keybind -> "RCONTROL".equals(keybind.getKey()));
		keybinds.add(new Keybind("RCONTROL", "clickgui"));
	...
	public void add(String key, String commands)
	{
		...
		keybinds.removeIf(keybind -> keyName.equals(keybind.getKey()));
	...
	{
		return commands.trim().replace("\r", "").replace("\n", " ");
	}
