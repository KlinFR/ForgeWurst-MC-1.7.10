...
public final class GuiInventoryVisitor extends WurstClassVisitor
{
	...
	public GuiInventoryVisitor(ClassVisitor cv, boolean obf)
	{
		...
		String initGuiName = mapMethodName(
			"net/minecraft/client/gui/inventory/GuiInventory", "initGui",
			"()V");
		String actionPerformedName = mapMethodName(
			"net/minecraft/client/gui/inventory/GuiInventory",
			"actionPerformed", "(L" + guiButton + ";)V");

		buttonListName = mapFieldName(
			"net/minecraft/client/gui/inventory/GuiInventory", "buttonList",
			"Ljava/util/List;");
		...
		public void visitInsn(int opcode)
		{
			if(opcode == Opcodes.RETURN)
			{
				...
				mv.visitFieldInsn(Opcodes.GETFIELD,
					"net/minecraft/client/gui/inventory/GuiInventory",
					buttonListName, "Ljava/util/List;");
